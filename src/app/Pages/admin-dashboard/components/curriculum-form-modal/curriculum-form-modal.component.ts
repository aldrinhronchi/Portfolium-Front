    ...
    switch (this.type) {
      case 'personal':
        formData = {
          ...
          YearsExperience: this.item.YearsExperience || 0,
          ProjectsCompleted: this.item.ProjectsCompleted || 0,
          HappyClients: this.item.HappyClients || 0,
          Certifications: this.item.Certifications || 0,
