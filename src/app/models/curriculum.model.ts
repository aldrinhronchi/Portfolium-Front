...
export interface Skill {
  ...
  Name: string;
  Level: number;
  Category: string; // Mudança: usar string ao invés de enum para compatibilidade
  DisplayOrder?: number;
  IsActive?: boolean;
  UserID?: number;
  Icon?: string;
...
export interface Experience {
  ...
  Location?: string;
  Description?: string;
  Responsibilities?: string; // JSON array como string
  Technologies?: string; // JSON array como string
  Achievements?: string; // JSON array como string
...
export interface Service {
  ...
  Description?: string;
  Icon?: string;
  Features?: string; // JSON array como string
  Price?: number;
  Currency?: string;
  Duration?: string;
  IsActive?: boolean;
